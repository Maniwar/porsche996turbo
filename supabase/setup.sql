...
('the-film', 'The Film', $kb$- "Look at Her" is the listing's own film: about four minutes with this car, from afternoon sun to sodium-lit night, cut to an original song of the same name written for this car by its owner, Maniwar. It is on the page in a section headed "The Film", above the photo gallery.
...
- The film is a portrait of the car, not a substitute for inspection. A buyer who asks what the film proves should be told plainly: it shows condition, colour in changing light, and how the car sounds and moves. It is not a condition report. The service file, the CARFAX and a pre-purchase inspection are what document the car, and a PPI is welcomed and encouraged.$kb$, true, 15),

('the-mezger-sound', 'The Mezger Sound', $kb$- 415 hp (420 PS), 3.6-litre twin-turbocharged Mezger flat-six. The two turbochargers are parallel, one per cylinder bank, not sequential. They were built by Kuehnle, Kopp & Kausch, the German maker known today as BorgWarner.
- The page carries a cold-start clip in a section headed "The Mezger Sound". Turn up the volume.$kb$, true, 90),
